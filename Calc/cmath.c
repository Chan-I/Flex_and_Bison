 ...
 * add two numbers
 *------------------------------------------------------------------*/
extern double ReduceAdd(double a, double b, YYLTYPE *bloc)
{
  return a + b;
}
/*--------------------------------------------------------------------
 ...
 * sub two numbers
 *------------------------------------------------------------------*/
extern double ReduceSub(double a, double b, YYLTYPE *bloc)
{
  return a - b;
}
/*--------------------------------------------------------------------
 ...
 *------------------------------------------------------------------*/
extern double ReduceMult(double a, double b, YYLTYPE *bloc)
{
  return a * b;
}
/*--------------------------------------------------------------------
 ...
 *------------------------------------------------------------------*/
extern double ReduceDiv(double a, double b, YYLTYPE *bloc)
{
  if (b == 0)
  {
 ...
 *------------------------------------------------------------------*/
extern void VarSetValue(Variable *var, double value)
{
  if (var == NULL)
    return;
  if (debug)
 ...
 *------------------------------------------------------------------*/
extern double VarGetValue(char *varname, YYLTYPE *bloc)
{
  Variable *var = NULL;
